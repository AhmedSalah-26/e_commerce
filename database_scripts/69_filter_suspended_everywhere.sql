-- =====================================================
-- Filter suspended products from all product queries
-- =====================================================

-- 1. Update materialized view to exclude suspended products
...
-- 2. Update get_discounted_products_fast to also filter (double safety)
...
-- 3. Ensure get_discounted_products_sorted also filters suspended
