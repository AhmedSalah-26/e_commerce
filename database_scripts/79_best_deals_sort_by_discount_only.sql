-- Update get_discounted_products_sorted to sort by discount percentage only
-- Best Deals should show highest discount first, regardless of flash sale status
...
SELECT id, name_ar, price, discount_price, 
       ROUND(((price - discount_price) / price * 100))::INTEGER as discount_pct,
       is_flash_sale
