-- =====================================================
-- Fix wallet payment_status in create_multi_vendor_order
-- The function was only setting pending for 'card', not 'wallet'
-- =====================================================

-- Drop and recreate the function with wallet support
...
BEGIN
  ...
  -- 'card' or 'wallet' means online payment waiting for confirmation (pending)
  -- 'cash_on_delivery' means pay on delivery
  IF p_payment_method IN ('card', 'wallet') THEN
...
-- Also fix existing wallet orders that have wrong payment_status
UPDATE orders
SET payment_status = 'pending', updated_at = NOW()
WHERE payment_method = 'wallet'
  AND payment_status = 'cash_on_delivery'
  AND status = 'pending';
...
-- =====================================================
-- Summary:
-- 1. Fixed create_multi_vendor_order to set pending for both card AND wallet
-- 2. Fixed existing wallet orders with wrong payment_status
-- =====================================================
