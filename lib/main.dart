      ...
      child: MaterialApp.router(
        theme: ThemeData.light().copyWith(
          ...
          inputDecorationTheme: InputDecorationTheme(
            labelStyle: const TextStyle(color: AppColours.brownMedium),
            floatingLabelStyle: const TextStyle(color: AppColours.brownMedium),
            hintStyle: const TextStyle(color: AppColours.greyMedium),
